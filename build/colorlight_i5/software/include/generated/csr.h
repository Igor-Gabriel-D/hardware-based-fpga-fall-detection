...
/* FALL_DETECT Registers */
#define CSR_FALL_DETECT_BASE (CSR_BASE + 0x2000L)
#define CSR_FALL_DETECT_AX_ADDR (CSR_BASE + 0x2000L)
#define CSR_FALL_DETECT_AX_SIZE 1
#define CSR_FALL_DETECT_AY_ADDR (CSR_BASE + 0x2004L)
#define CSR_FALL_DETECT_AY_SIZE 1
#define CSR_FALL_DETECT_AZ_ADDR (CSR_BASE + 0x2008L)
#define CSR_FALL_DETECT_AZ_SIZE 1
#define CSR_FALL_DETECT_DATA_VALID_ADDR (CSR_BASE + 0x200cL)
#define CSR_FALL_DETECT_DATA_VALID_SIZE 1
#define CSR_FALL_DETECT_MAG_SQ_ADDR (CSR_BASE + 0x2010L)
#define CSR_FALL_DETECT_MAG_SQ_SIZE 1
#define CSR_FALL_DETECT_MAG_VALID_ADDR (CSR_BASE + 0x2014L)
#define CSR_FALL_DETECT_MAG_VALID_SIZE 1
...
/* SPIFLASH Registers */
#define CSR_SPIFLASH_BASE (CSR_BASE + 0x4000L)
#define CSR_SPIFLASH_PHY_CLK_DIVISOR_ADDR (CSR_BASE + 0x4000L)
#define CSR_SPIFLASH_PHY_CLK_DIVISOR_SIZE 1
#define CSR_SPIFLASH_MMAP_DUMMY_BITS_ADDR (CSR_BASE + 0x4004L)
#define CSR_SPIFLASH_MMAP_DUMMY_BITS_SIZE 1
#define CSR_SPIFLASH_MASTER_CS_ADDR (CSR_BASE + 0x4008L)
#define CSR_SPIFLASH_MASTER_CS_SIZE 1
#define CSR_SPIFLASH_MASTER_PHYCONFIG_ADDR (CSR_BASE + 0x400cL)
#define CSR_SPIFLASH_MASTER_PHYCONFIG_SIZE 1
#define CSR_SPIFLASH_MASTER_RXTX_ADDR (CSR_BASE + 0x4010L)
#define CSR_SPIFLASH_MASTER_RXTX_SIZE 1
#define CSR_SPIFLASH_MASTER_STATUS_ADDR (CSR_BASE + 0x4014L)
...
/* FALL_DETECT Access Functions */
static inline uint32_t fall_detect_ax_read(void) {
	return csr_read_simple((CSR_BASE + 0x2000L));
}
static inline void fall_detect_ax_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x2000L));
}
static inline uint32_t fall_detect_ay_read(void) {
	return csr_read_simple((CSR_BASE + 0x2004L));
}
static inline void fall_detect_ay_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x2004L));
}
static inline uint32_t fall_detect_az_read(void) {
	return csr_read_simple((CSR_BASE + 0x2008L));
}
static inline void fall_detect_az_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x2008L));
}
static inline uint32_t fall_detect_data_valid_read(void) {
	return csr_read_simple((CSR_BASE + 0x200cL));
}
static inline void fall_detect_data_valid_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x200cL));
}
static inline uint32_t fall_detect_mag_sq_read(void) {
	return csr_read_simple((CSR_BASE + 0x2010L));
}
static inline uint32_t fall_detect_mag_valid_read(void) {
